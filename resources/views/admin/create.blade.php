...
<head>
    <meta charset="utf-8">
    <title>D2T Hotel - Add New Admin</title>
                ...
                <div class="bg-secondary rounded h-100 p-4">
                    <form method="post" action="{{ Route('admin.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" maxlength="50" required placeholder="enter your email" class="form-control" name="email" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
